# -*- coding: utf-8 -*-
"""
Created on Sat Feb 23 22:12:59 2019
...
for ligne in range(s.nrows):
    for col in range(s.ncols):
        keywords.append(s.cell(ligne,col).value)
...
s_w_numbers={} # a dictionnary to store all the sentences with numbers
return_string=""
